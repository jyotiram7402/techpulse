  ...
  return (
    <div className="container max-w-3xl space-y-6 py-8">
      <div>
        ...
        <p className="text-muted-foreground">Customize your feed and manage your account.</p>
      </div>
        ...
        <CardContent className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-muted-foreground">Member since {new Date(user.created_at).getFullYear()}</div>
            </div>
          </div>
          <form action={signOut}>
